/* based on:
1. https://www.openprocessing.org/sketch/184838
2. https://www.openprocessing.org/sketch/720376
3. https://www.openprocessing.org/sketch/728303
*/
...
void drawNoiseLoop(float cx, float cy, float cr) {
  int cnt = 50; 
  beginShape(); 
