...
Normally, fire and ice can’t coexist, but in my Jerusalem ice can burn into fire. This revel one of the greatest joy of coding that you the god for your program, and here I make two contradictory things look harmonious.

<a href="./ice_and_fire/ice_and_fire.pde"><img src="./ice_and_fire/screenshots/example.gif" height="500px"></a>

## Tree Plant

A flower can be a world, and a particle can a plant.

I based the Plant created by [Santiago Fiorino](https://www.openprocessing.org/sketch/567018) to build a plant can grows trees by my own, Each time you click the plant, it will grow a tree with random color. And on this tree plant, it can only consist of three at most, otherwise the extra tree will die.
...
In my Jerusalem, it is the Gluttonous Squid which is a inspired of this this [Weird tentacle thingie](https://www.openprocessing.org/sketch/184838). It is so cute that you will not be angry at all even it eat colorful plants for fun. The closer the mouse to it, the larger and faster it is.
